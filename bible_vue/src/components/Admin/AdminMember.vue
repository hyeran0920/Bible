      ...
      <div class="memberInfo" v-for="member in members" :key="member.memId">
          <div class="member-card">
              ...
              <div class="member-actions">
                  ...
                  <button v-if="!isAdmin" @click="openModal(true, member)" type="button" class="btn btn-edit">정보 수정</button>
                  <button @click="promptDelete(member.memId, member.memEmail)" type="button" class="btn btn-delete">회원 탈퇴</button>
              </div>
          </div>
      </div>
  ...
  export default{
      ...
      methods:{
          ...
          async promptDelete(memId, memEmail){
              ...
              if(userInput && userInput === memEmail){
                  try{
